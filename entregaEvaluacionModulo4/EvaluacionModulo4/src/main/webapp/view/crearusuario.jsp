...
<body>
	...
	<div class="container">
		<div class="contact-box">
			<div class="left2"></div>
			<div class="right">
				<h4>Formulario de Registro Para Nuevos Usuarios</h4>
							<!-- Controlador (estaba abajo en action)-->
				<form action="${accion}" method="POST">
					<!--value="${cap.getIdCapacitacion()}"  -->
					<div class="mb-3">
						<label for="txtId" class="form-label">ID Usuario</label><input
							type="text" class="form-control" id="idUsuario" name="idUsuario">
					</div>
					<div class="mb-3">
						<label for="txtRun" class="form-label">Run Usuario</label><input
							type="text" class="form-control" id="txtRun"
							name="txtRun">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="txtFec" class="form-label">Fecha nacimiento</label><input type="text" class="form-control"
							id="txtFec" name="txtFec">
					</div>
					<div class="mb-3">
						<label for="txtTip" class="form-label">Tipo Usuario</label><input type="text" class="form-control" id="txtTip"
							name="txtTip">
					</div>
